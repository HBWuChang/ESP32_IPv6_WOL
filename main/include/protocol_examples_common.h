 ...
 */
esp_err_t example_connect(const char *wifi_ssid, const char *wifi_passwd);
...
#else
static inline esp_err_t example_connect(const char *wifi_ssid, const char *wifi_passwd) {return ESP_OK;}
#endif // !CONFIG_IDF_TARGET_LINUX
